                ...
                <div class="contentDetails row m-0">
                    <div class="col-md-6">
                        ...
                        <div class="col-11 socialShare">
                            <button class="button"
                                data-sharer="twitter"
                                data-url="{{ route('frontend.lectures.lecture_content', $lecture->slug) }}">
                    ...
                    <div class="col-md-6 contentImg">
                        ...
                        <div class="img-title">
                            <a href="{{ asset('Files/image/Lectures/' . $lecture->name . '/' . $lecture->image->file_name) }}">
                        ...
                        @else
                        <div class="img-title">
                            <a href="{{ asset('frontend/img/lectures.webp') }}">
