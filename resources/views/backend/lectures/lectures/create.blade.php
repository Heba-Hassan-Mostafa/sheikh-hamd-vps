    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('lectures.lecture-create') }}</span>
            </div>
        </div>
                                    ...
                                    @foreach ($categories as $category)
                                        <ul class="col-4 parentCategory">
                                            ...
                                            <label style="font-size: 16px;">
                                                {{ Form::radio('lecture_category_id', $category->id, false, ['class' => 'name']) }}
                                                {{ $category->name }}</label>

                                            @include('backend.lectures.lectures.subCategoryList', [
