...
@endsection
@section('title')
    {{ trans('benefits.category-create') }}
@endsection
@section('page-header')
    <!-- breadcrumb -->
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('benefits.category-create') }}</span>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">{{ trans('benefits.category-create') }}</h4>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.benefit-categories.store') }}" method="Post">
                        @csrf
                        <div class="row">
                                ...
                                <ul id="treeview1">
                                    ...
                                    @foreach ($categories as $category)
                                        <ul class="col-4 parentCategory">
                                            ...
                                            @include('backend.benefits.categories.subCategoryList', [
