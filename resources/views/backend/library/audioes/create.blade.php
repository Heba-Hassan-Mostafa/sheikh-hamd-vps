    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('audioes.audio-create') }}</span>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">{{ trans('audioes.audio-create') }}</h4>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.library-audio.store') }}" method="Post" enctype="multipart/form-data">
                        @csrf
                                    ...
                                    <select name="audio_category_id" class="form-control">
                                        ...
                                        @forelse ($categories as $category)
                                            <option value="{{ $category->id }}"
                                                {{ old('audio_category_id') == $category->id ? 'selected' : null }}>
