    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('videos.edit-category') }}</span>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">{{ trans('videos.edit-category') }}</h4>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.video-categories.update',$model->id) }}" method="Post">
                        @csrf
                        @method('PATCH')
                        <div class="row">
