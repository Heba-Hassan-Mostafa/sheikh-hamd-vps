    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('lessons.category-edit') }}</span>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">{{ trans('lessons.category-edit') }}</h4>
                        <a href="{{ route('admin.lesson-categories.index') }}" class="btn btn-primary">
                            <i class="fa fa-home"></i>
                            <span class="text">{{ trans('lessons.categories') }}</span>
                        </a>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.lesson-categories.update',$model->id) }}" method="Post">
                        @csrf
                        @method('PATCH')
                        <div class="row ">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="name">{{ trans('lessons.category-name') }}</label>
                                ...
                                <ul id="treeview1">
                                    ...
                                    <ul class="col-4 parentCategory">
                                        ...
                                        @if (count($category->subcategory))
                                            @include('backend.lessons.categories.subCategoryListEdit', [
