    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('books.category-edit') }}</span>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">{{ trans('books.category-edit') }}</h4>
                        <a href="{{ route('admin.book-categories.index') }}" class="btn btn-primary">
                            <i class="fa fa-home"></i>
                            <span class="text">{{ trans('books.categories') }}</span>
                        </a>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.book-categories.update',$model->id) }}" method="Post">
                        @csrf
                        @method('PATCH')
                        <div class="row ">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="name">{{ trans('books.category-name') }}</label>
                                ...
                                <ul id="treeview1">
                                    ...
                                    <ul class="col-4 parentCategory">
                                        ...
                                        @if (count($category->subcategory))
                                            @include('backend.books.categories.subCategoryListEdit', [
