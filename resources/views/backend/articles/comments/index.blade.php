...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> {{ trans('articles.comments') }}</h4>
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/{{ trans('articles.comments-list') }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
        ...
        <div class="card">
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                    <h4 class="card-title mg-b-0"> {{ trans('articles.comments-list') }}</h4>
                    ...
                    <table class="table text-md-nowrap" id="example1">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th class="wd-15p border-bottom-0">{{ trans('articles.comment') }}</th>
                                <th class="wd-15p border-bottom-0">{{ trans('articles.comment-belongs-to') }}</th>
                                            ...
                                            <div class="modal-content tx-size-sm">
                                                <div class="modal-header pd-x-20">
                                                    <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">
                                                        {{ trans('articles.show-comment') }}</h6>
                ...
                <div class="modal fade" id="delete_all" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('admin.article-comments.delete_all') }}" method="POST">
                                {{ csrf_field() }}
