        ...
        <div class="card">
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                    <h4 class="card-title mg-b-0">{{ trans('articles.category-list') }}</h4>


                </div>
            </div>
            <div class="card-body">
                <a href="{{ route('admin.article-categories.create') }}" class="btn btn-success font-weight-bold" role="button"
                ...
                <div class="row">
					<div class="col-lg-12 col-md-12">
						<div class="card overflow-hidden">
							<div class="card-header pb-0">
								<h3 class="card-title">{{ trans('articles.categories') }}</h3>
										...
										<div class="panel-heading1 bg-primary ">
											<h4 class="panel-title1">
												<a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion11" href="#collapseFour1" aria-expanded="false">
                                                    <i class="fe fe-arrow-left ml-2"></i>  {{ trans('articles.all-main-categories') }}</a>
											</h4>
										</div>
										<div id="collapseFour1" class="panel-collapse collapse" role="tabpanel" aria-expanded="false">
											<div class="panel-body border">
                                                @livewire('article-category-reorder')
											</div>
										</div>
									</div>
										...
										<div class="panel-heading1  bg-primary">
											<h4 class="panel-title1">
												<a class="accordion-toggle mb-0 collapsed" data-toggle="collapse" data-parent="#accordion11" href="#collapseFive2" aria-expanded="false">
                                                     <i class="fe fe-arrow-left ml-2"></i>{{ trans('articles.all-sub-categories') }}</a>
											</h4>
										</div>
                                                    ...
                                                    <table class="table text-md-nowrap" id="example1">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="wd-15p border-bottom-0">{{ trans('articles.category-parent') }}</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{ $subCategory->articles->count() }}</td>
                                                                ...
                                                                <td>
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <a href="{{ route('admin.article-categories.edit', $subCategory->id) }}"
                                                                            class="btn btn-info btn-sm" role="button" aria-pressed="true">
                                                                            <i class="fa fa-edit"></i></a>


                                                                    <form action="{{ route('admin.article-categories.destroy', $subCategory->id) }}" method="POST"
                                                                        class="dnone">
                                                                        @csrf
                                                                        @method('Delete')
