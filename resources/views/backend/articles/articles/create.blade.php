    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('articles.article-create') }}</span>
            </div>
        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-flex row m-0 mb-3">
                                        ...
                                        <p class="col-6 mt-2" style="color: #03aad7; text-align: left;">
                                            ...
                                            <span style="color: red">40</span> {{ trans('articles.chars') }}
                                        </p>
                                    </div>
                                    @error('name')
                                    ...
                                    @foreach ($categories as $category)
                                        <ul class="col-4 parentCategory">
                                            ...
                                            <label style="font-size: 16px;">
                                                {{ Form::radio('article_category_id', $category->id, false, ['class' => 'name']) }}
                                                {{ $category->name }}</label>

                                            @include('backend.articles.articles.subCategoryList', [
