    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('btns.edit') }}</span>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">{{ trans('users.user-edit') }} --> {{ $user->full_name }}</h4>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.users.update',$user->id) }}" method="Post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="name">{{ trans('users.password') }}</label>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="name">{{ trans('users.confirm-password') }}</label>
                        ...
                        <div class="form-group pt-4">
                            <button type="submit" name="save" class="btn btn-primary"> {{ trans('btns.save') }}</button>
