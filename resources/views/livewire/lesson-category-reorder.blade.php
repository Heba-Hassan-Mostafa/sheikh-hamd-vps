<div class="table-responsive" wire:ignore>
    <table class="table text-md-nowrap" id="example1">
        ...
        <tbody wire:sortable="updateCategoryOrder">
            ...
            <tr class="reOrder" wire:sortable.item="{{ $category->id }}" wire:key="lessonCategory-{{ $category->id }}"
                ...
                <td>
                    <div class="btn-group">
                        ...
                        <a href="{{ route('admin.lesson-categories.edit', $category->id) }}"
                            class="btn btn-info btn-sm" role="button" aria-pressed="true">
                            <i class="fa fa-edit"></i></a>


                    <form action="{{ route('admin.lesson-categories.destroy', $category->id) }}" method="POST"
                        class="dnone">
                        @csrf
                        @method('Delete')
